                ...
                <div class="d-block d-lg-flex justify-content-between align-items-center">
                    <div class="left_img_text">
                        <div class="cart_small_img">
                            <a href="" style="color:black; text-decoration:unset;"><img
                                    src="{{ storage::url($cart->product['image']) }}" alt="" /></a>
                        </div>
                        <div class="img_left_text">
                            <h5><a href="" style="color:black; text-decoration:unset;">
                                    {!! Str::limit($cart['product']['name'], 17, ' ...') !!}</a></h5>
                            @if (AddToCart::CheckStock($cart['product']['id']) == 0)
                    ...
                    <div class="small_number me-3">
                        <form>
                            <div class="value-button decrease" data-id="{{ $cart['id'] }}" id="decrease"
                                value="Decrease Value"><i class="fa-solid fa-minus"></i></div>
                            <input type="number" id="number" data-id="{{ $cart['id'] }}" class="number"
                                value="{{ $cart['quantity'] }}" min="1" />
                            <div class="value-button increase" data-id="{{ $cart['id'] }}" id="increase"
                                value="Increase Value"><i class="fa-solid fa-plus"></i></div>
                        </form>
                    </div>
